...
export const createJob = (data: Partial<JobItem>): Promise<number> =>
  request.post('/monitor/job', data)

export const updateJob = (data: Partial<JobItem>): Promise<void> =>
  request.put('/monitor/job', data)
...
export const runJobOnce = (id: number): Promise<void> =>
  request.post(`/monitor/job/${id}/run`)
