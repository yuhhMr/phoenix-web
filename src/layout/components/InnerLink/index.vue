...
/**
 * 外链容器 —— 对照 Jarvis-web src/layout/components/InnerLink/index.vue 移植。
 * 路由 meta.link 存在时以 iframe 内嵌外链页面。
 * phoenix 当前没有外链路由（静态路由表未配 meta.link），组件先就位，
 * 将来动态路由（/auth/routes 端点）落地时供 component='InnerLink' 的菜单使用。
 */
